   ...
   <head>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="dashboard.jsp" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>Delete Student</h2>
        </a>
...
<table class="table" class="table-dark">
    ...
    <tr>
      ...
      <td><a href="updatestudent.jsp?id=<%=id%>"><button type="submit" class="btn btn-primary" style="color: white;" hidden="">Edit</button></td>
      <td><a href="deletestudent.jsp?id=<%=id%>"><button type="submit" class="btn btn-danger" style="color: white;">Delete</button></td>
